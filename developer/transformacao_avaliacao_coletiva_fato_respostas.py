    ...
    def transformar_trusted_fato_respostas(self):
        ...
        for i_entrevistado in range(1,df_copy.shape[0]):
            ...
            fato_resposta = {
                ...
                'nmCadernoPergunta': 'Avaliação coletiva (respostas)',  # modificar para cada formulário
                'dsTituloPergunta': perguntas,  # lista com as perguntas
                'dsTipoPergunta': tipo_perguntas,  # lista com o tipo das perguntas
                'dsResposta': row.iloc[5:22].tolist(),  # lista com as respostas
...
if __name__ == "__main__":
    ...
    file_name = "avaliacao_coletiva.xlsx"
    relatorio = "avaliacao_coletiva"
