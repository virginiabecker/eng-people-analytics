...
from transformacao_autoavaliacao_fato_respostas import processar_fato_respostas, TransformerFatoRespostas

# Definições iniciais
relatorio = 'autoavaliacao'  # Opções: autoavaliacao, avaliacao_coletiva, avaliacao_projeto, #avaliacao_individual
#camada = 'raw'
...
try:
    #Enviar notificação de inicio do processo
    ...
    #Enviar notificação de falha no processo com log de erro (Exception)
